...
class ModelArguments:
    ...
    hq: Optional[bool] = field(
        default=False,
        metadata={"help": "Use our hybrid quantization strategy or original model"},
    )
    budget_memory: Optional[str] = field(
        default=14 * 1024 * 1024 * 1024,
        metadata={"help": "step_memory"},
    )
    step_memory: Optional[str] = field(
        default=2 * 32 * 1 * 4096 * 32 * 2,
        metadata={"help": "step_memory"},
    )
