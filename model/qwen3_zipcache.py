...
class Qwen3Attention(nn.Module):
    ...
    def __init__(self, config: Qwen3Config, compress_config=None, layer_idx: int = 0):
        super().__init__()
        self.config = config
...
class Qwen3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3Config, compress_config=None, layer_idx: int=0):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Qwen3Attention(config=config, compress_config=compress_config, layer_idx=layer_idx)
...
class Qwen3Model(Qwen3PreTrainedModel):
    def __init__(self, config: Qwen3Config, compress_config=None):
        ...
        self.layers = nn.ModuleList(
            [Qwen3DecoderLayer(config, compress_config=compress_config, layer_idx=layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
...
class Qwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config, compress_config):
        super().__init__(config)
        self.model = Qwen3Model(config, compress_config=compress_config)
        self.vocab_size = config.vocab_size
