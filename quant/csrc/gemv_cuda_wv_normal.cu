...
__global__ void bgemv_kernel_wv_normalize_group_8(
...
__global__ void bgemv_kernel_wv_normalize_group_4(
  const half* _inputs, const uint32_t* _weight, const half* _means, const half* _std, const float* _normal_quantiles_center, 
  half* _outputs, const int IC, const int OC, const int OL,
  const int group_size, const int bit, const int nh_q, const int nh_kv){
...
__global__ void bgemv_kernel_wv_normalize_group_2(
  const half* _inputs, const uint32_t* _weight, const half* _means, const half* _std, const float* _normal_quantiles_center, 
  half* _outputs, const int IC, const int OC, const int OL,
  const int group_size, const int bit, const int nh_q, const int nh_kv){
...
__global__ void bgemv_kernel_wv_normalize_group_1(
  const half* _inputs, const uint32_t* _weight, const half* _means, const half* _std, const float* _normal_quantiles_center, 
 half* _outputs, const int IC, const int OC, const int OL,
  const int group_size, const int bit, const int nh_q, const int nh_kv){
    ...
    const int nh_kv)
{
    ...
    // 进行核函数计算
    if (bit == 8){
      bgemv_kernel_wv_normalize_group_8<<<num_blocks, num_threads>>>(
        // pointers
      ...
      bgemv_kernel_wv_normalize_group_4<<<num_blocks, num_threads>>>(
        // pointers
        in_feats, kernel, means, stds, normal_quantiles_center, out_feats,
        // constants
        num_in_channels, num_out_channels, num_out_lines, group_size, bit, nh_q, nh_kv
      ...
      bgemv_kernel_wv_normalize_group_2<<<num_blocks, num_threads>>>(
        // pointers
        in_feats, kernel, means, stds, normal_quantiles_center, out_feats,
        // constants
        num_in_channels, num_out_channels, num_out_lines, group_size, bit, nh_q, nh_kv
      ...
      bgemv_kernel_wv_normalize_group_1<<<num_blocks, num_threads>>>(
        // pointers
        in_feats, kernel, means, stds, normal_quantiles_center, out_feats,
        // constants
        num_in_channels, num_out_channels, num_out_lines, group_size, bit, nh_q, nh_kv
